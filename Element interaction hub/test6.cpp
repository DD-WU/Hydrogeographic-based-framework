...
test6::test6(const char* config_name, const char* sheet_name)
{
...
void test6::afterInit()
{
}

void test6::beforeUpdate()
{
...
void test6::afterUpdate()
{

}

void test6::beforeFinalize()
{
}
