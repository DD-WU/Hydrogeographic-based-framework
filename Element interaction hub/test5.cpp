...
test5::test5(const char* config_name, const char* sheet_name)
{
...
void test5::beforeInit()
{
	...
	dam = new Dam(config);
	buildings = new Buildings(config);
...
void test5::afterInit()
{
}

void test5::beforeUpdate()
{
...
void test5::afterUpdate()
{

}

void test5::beforeFinalize()
{
}
