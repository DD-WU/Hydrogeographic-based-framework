...
!=========================================================================|
   ...
   ALLOCATE(FLUXOBN2(1:IOBCN))               ;FLUXOBN2      = ZERO
   ALLOCATE(CXOBC(NT))                       ;CXOBC         = ZERO
   ALLOCATE(CYOBC(NT))                       ;CYOBC         = ZERO
   ALLOCATE(FLUXOBC2D_X(1:nmfcell))          ;FLUXOBC2D_X   = ZERO
   ALLOCATE(FLUXOBC2D_Y(1:nmfcell))          ;FLUXOBC2D_Y   = ZERO
   ALLOCATE(FLUXOBC3D_X(1:nmfcell,1:KBM1))   ;FLUXOBC3D_X   = ZERO
   ALLOCATE(FLUXOBC3D_Y(1:nmfcell,1:KBM1))   ;FLUXOBC3D_Y   = ZERO
   ALLOCATE(FLUXOBC3D_X_2(1:nmfcell,1:KBM1)) ;FLUXOBC3D_X_2 = ZERO
   ALLOCATE(FLUXOBC3D_Y_2(1:nmfcell,1:KBM1)) ;FLUXOBC3D_Y_2 = ZERO

   ALLOCATE(OBC2D_X_TIDE(1:nmfcell),OBC2D_Y_TIDE(1:nmfcell)) 
...
! 2-D and 3-D adjustment
      ...
      DO I = 1, nmfcell
         ...
         DO K=1,KBM1
            UTMP = UTMP + UNT(I,K)*DZ(K)
            VTMP = VTMP + VNT(I,K)*DZ(K)
         END DO
         UTMP = UTMP * DTMP
         VTMP = VTMP * DTMP
         DO K=1,KBM1
...
! 2-D and 3-D adjustment
      DO I = 1, nmfcell
         UTMP   = SUM(UNT(I,1:KBM1)*DZ(1:KBM1))
         VTMP   = SUM(VNT(I,1:KBM1)*DZ(1:KBM1))
