MODULE MOD_OBCS2
   ...
   INTEGER              :: ntidecell_GL, ntidecell
   INTEGER              :: ntidenode_GL, ntidenode
...
!--------------------------------------------------------------------------|
  ...
  DO I = 1,nmfcell
     ...
     CC = SQRT(GRAV*D1(II))*ALPHA_RK(KTT)*DTE/DLTN(I)
     CP = CC + 1.0_SP
