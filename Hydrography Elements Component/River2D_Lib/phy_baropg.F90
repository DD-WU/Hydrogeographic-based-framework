   ...
   DO I=1,N
     ...
     DO K=1,KBBM1
       ...
       ELSE
         ...
         PB1(K)=PB1(K-1)+GRAV*RHOZI1*DELTZ
         PB2(K)=PB2(K-1)+GRAV*RHOZI2*DELTZ
         PB3(K)=PB3(K-1)+GRAV*RHOZI3*DELTZ
         NTMP=NTMP+1
       END IF
     END DO
     ...
     DO K=1,KBM1
       DRHOX(I,K)=-PBXS(K)*DT1(I)*ART(I)*RAMP1
       DRHOY(I,K)=-PBYS(K)*DT1(I)*ART(I)*RAMP1
     END DO
   END DO
