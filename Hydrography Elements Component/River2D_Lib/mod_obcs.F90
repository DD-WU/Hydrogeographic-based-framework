...
!--------------------------------------------------------------------------|
   ...
   DO J = 1,IBCN(3)
     ...
     I1 =  I_OBC_N(JN) 
     I2 = NEXT_OBC(JN) 
     CC = SQRT(GRAV*H(I1))*DTE/DLTN_OBC(JN)
     CP = CC + 1.0_SP
...
!if (SPHERICAL==1) USE MOD_SPHERICAL
...
!==============================================================================|
   ...
   CASE(4)
     ...
     SM22D_NEXT1=0.0_SP
     DO K=1,KBM1
       S2D_NEXT1  =S2D_NEXT1  +S1(J1,K)*DZ(K)
       SM12D_NEXT2=SM12D_NEXT2+S1M1(J2,K)*DZ(K)
       SM12D_NEXT1=SM12D_NEXT1+S1M1(J,K)*DZ(K)
       SM22D_NEXT1=SM22D_NEXT1+S1M2(J1,K)*DZ(K)
     END DO
